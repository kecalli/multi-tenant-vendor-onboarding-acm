...
2. The `vendor-a-sample-app` application is already present, pre-wired by the onboarding script.
3. Click the application to open the **Topology view**. The vendor sees a live, interactive graph showing their `ConfigMap`, `Deployment`, `Service`, and `Route` — all running within their isolated namespace.
